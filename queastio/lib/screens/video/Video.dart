...
//  final String url;
  VideoAdmin(this.data);

  @override
  VideoState createState() => VideoState(this.data);
}
...
//    print("What we got is ${url}");
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(data.qname.toUpperCase()),
      ),
...
//                                child:
                                  ...
                                  Row(
                                    children: [SizedBox(width: 20),
                                      Text('Quiz :  ${data.qname.toUpperCase()}',style: TextStyle(color: Colors.white70),
                              ...
                              Row(
                                children: [SizedBox(width: 20),
                                  Text('Branch :  ${userData.batch}',style: TextStyle(color: Colors.white70),
                                    textAlign: TextAlign.left,),
                                ],
                              ),Row(
                                children: [SizedBox(width: 20),
